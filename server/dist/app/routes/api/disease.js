...
validation_1.diseaseValidation.name((0, express_validator_1.body)('name')), validation_1.validation, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const disease = yield prisma_1.default.disease.create({
...
validation_1.diseaseValidation.name((0, express_validator_1.query)('name')).optional(), validation_1.validation, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
